...
public:
  ...
  virtual void failedMacroDefinitionCheck(unsigned offset, const StringRef &name) = 0;
  ...
  virtual void markAsIncludeGuard(const String &macroName) = 0;
